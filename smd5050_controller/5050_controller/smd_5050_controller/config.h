...
// MQTT
#define CONFIG_MQTT_HOST "xxx"
#define CONFIG_MQTT_PORT 1883 // Usually 1883
#define CONFIG_MQTT_USER "xxx"
#define CONFIG_MQTT_PASS "xxx"
#define CONFIG_MQTT_CLIENT_ID "xxx" // Must be unique on the MQTT network

// MQTT Topics
#define CONFIG_MQTT_TOPIC_STATE "xxx"
#define CONFIG_MQTT_TOPIC_SET "xxx"
...
#define CONFIG_DEFAULT_FLASH_LENGTH 15
...
#define CONFIG_BUILTIN_LED_MODE 0
